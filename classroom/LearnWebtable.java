...
public class LearnWebtable {
	...
	public static void main(String[] args) {
		...
		// get the coloumnsize
		List<WebElement> columnsize = driver
				.findElements(By.xpath("//table[@class='DataTable TrainList TrainListHeader']//tr[2]/td"));
		System.out.println(columnsize.size());

		// Get the particular value
		String onename = driver.findElement(By.xpath("//table[@class='DataTable TrainList TrainListHeader']//tr/td[2]"))
				.getText();
